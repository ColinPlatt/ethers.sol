...
contract jsonRPCProvider {
    ...
    function _subscriptionTypeToString(subscriptionType _type) public pure returns (string memory) {
    ...
    function _blockTagToString(blockTag _tag) public pure returns (string memory) {
    ...
    function eth_estimateGas(Transaction memory _transaction, blockTag _blockTag) public pure returns (string memory) {
        return _request('eth_estimateGas', string.concat(_transaction.read(), ',"', _blockTagToString(_blockTag), '"'));
    }

    function eth_estimateGas(string memory _transaction, blockTag _blockTag) public pure returns (string memory) {
    ...
    function eth_getTransactionReceipt(string memory _variableName) public pure returns (string memory) {
