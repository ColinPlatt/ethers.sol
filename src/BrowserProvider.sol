...
contract BrowserProvider is jsonRPCProvider {
    ...
    function checkAndChangeChain() public pure returns (string memory) {
    ...
    function _nativeCurrency(NativeCurrency memory nativeCurrency) public pure returns (string memory) {
        return string.concat(
            '{"name":"',
            nativeCurrency.name,
            '","symbol":"',
    ...
    function _newKey(Key memory _Key) public pure returns (string memory) {
